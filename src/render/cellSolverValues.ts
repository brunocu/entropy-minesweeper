...
//
// The conversions around this stay separate: they disagree about flags, mines, hover highlights
// and simulated reveals, and merging them would need a parameter per caller. This rule is the one
// thing all three genuinely share.
